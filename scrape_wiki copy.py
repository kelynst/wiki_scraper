...
# Default category (you can change this, but you can also pass --url from CLI)
DEFAULT_URL = "https://en.wikipedia.org/wiki/Category:Phobias"

# Polite, professional User-Agent (points to your repo; no personal email needed)
USER_AGENT = "KelynWikipediaScraper/1.1 (+https://github.com/kelynst/wiki_scraper)"

def fetch(url: str, timeout: int = 20) -> str:
    """Download a page and return HTML text."""
